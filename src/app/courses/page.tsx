...
import courseData from "@/data/web_courses.json"
function page() {
    return (
        <div className="min-h-screen bg-black py-12 pt-36">
            ...
            <p className="text-center">These are just suggestions of some good videos and playlists for respected topics. (subjective)</p>
            <div className="flex flex-wrap justify-center">
            {courseData.courses.map((course) => (
                <a key={course.id} href={course.playlist_link} target="_blank">
